...
<head>
    ...
    .job-location, .job-description, .job-skill, .job-experience {
        font-size: 14px;
        color: #555;
        margin-bottom: 10px;
    }
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<h3 class="job-title"><strong>Job Title:</strong>' . $row["jobTitle"] . '</h3>';
                echo '<p class="job-company"><i class="fas fa-building"></i><strong>Company Name:</strong> ' . $row["companyName"] . '</p>';
                echo '<p class="job-location"><i class="fas fa-map-marker-alt"></i><strong>Job Location:</strong> ' . $row["jobLocation"] . '</p>';
                echo '<p class="job-description"><strong>Description:</strong>' . $row["jobDescription"] . '</p>';
                echo '<p class="job-skill"><strong>Skills Required:</strong> ' . $row["skillsRequired"] . '</p>';
                echo '<p class="job-experience"><strong>Experience Required:</strong> ' . $row["experienceRequired"] . '</p>';
                
                echo '<a href="jregister.html" class="job-apply-button">Apply Now</a>';
                echo '</div>';
            }
        } else {
